		...
		void flights()
		{
			...
			switch(choice)
			{
				case 1:
					...
					case 2:
						{
								cout<<"________________Welcome to Canadian Airlines_________________\n"<<endl;
						...
						cout<<"3. CA -208"<<endl;
						cout<<"\t01-01-2022 12:00AM  21hrs  Rs.40000"<<endl;
				...
				case 3:
					...
					case 4:
						{
									cout<<"________________Welcome to US Airways_________________\n"<<endl;
						...
						cout<<"1. US -567"<<endl;
						cout<<"\t10-01-2022 9:00PM  22hrs  Rs.37000"<<endl;
						cout<<"2. US -658"<<endl;
				...
				case 5:
					{
								cout<<"________________Welcome to Australian Airlines_________________\n"<<endl;
					...
					case 6:
						{
									cout<<"________________Welcome to Europian Airlines_________________\n"<<endl;
					...
					default:
						{
							cout<<"Invalid input, Shiftimh you to the main menu !"<<endl;
							mainMenu();
							break;
						}
	...
	public:
		void Bill()
		{
			...
			ofstream outf("records.txt");
			{
				...
				outf<<"___________Ticket________________"<<endl;
...
void mainMenu()
{
	...
	switch(lchoice)
	{
		...
		case 2:
			{
				cout<<"______Book a flight using this system_____\n"<<endl;
				r.flights();
				break;
			}
